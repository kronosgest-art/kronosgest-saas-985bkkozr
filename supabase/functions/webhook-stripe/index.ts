          ...
          if (resendApiKey) {
            await fetch('https://api.resend.com/emails', {
              ...
              body: JSON.stringify({
                ...
                html: `<p>Sua conta foi criada com sucesso.</p><p>Email: ${guestData.email}</p><p>Senha temporária: <strong>${tempPassword}</strong></p><p>Acesse: <a href="https://kronosgest.com.br/login">https://kronosgest.com.br/login</a></p><p>Sua Nota Fiscal será emitida automaticamente pelo nosso sistema em breve.</p>`,
              }),
            })
          } else {
            console.log(
